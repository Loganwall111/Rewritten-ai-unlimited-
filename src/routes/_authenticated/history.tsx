...
export const Route = createFileRoute("/_authenticated/history")({ component: () => (
  <div>
    <PageHero eyebrow="History" title="Every session, every render.">Local history is preserved across visits.</PageHero>
    <LensWrap>
