...
export const Route = createFileRoute("/_authenticated/code")({
  component: () => (
    <StubPage title="Code Generation" desc="Full-stack scaffolds, refactors, playable snippets." />
  ),
});
      ...
      <LensWrap>
        <div className="glass-panel-strong rounded-2xl p-10 text-center">
          <p className="text-sm text-[#E0F7FA]/60">
            This surface is wired to the same model catalog as chat. Ping it from the Chat tab or
            run a prompt below.
          </p>
          <textarea
            placeholder="Describe what to build…"
            className="mt-6 w-full h-40 rounded-xl glass-panel bg-transparent p-4 text-sm text-[#E0F7FA] outline-none focus:border-[#00F2FF]/40"
          />
