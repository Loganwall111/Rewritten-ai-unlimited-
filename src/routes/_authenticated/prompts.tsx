...
export const Route = createFileRoute("/_authenticated/prompts")({ component: () => (
  <div>
    <PageHero eyebrow="Prompt Vault" title="Save · share · remix.">Every prompt from Base44 kept.</PageHero>
