...
export const SCENES: SceneEntry[] = [
  ...
  e(
    "landing",
    "Cosmic Gateway",
    "Glowing icosphere, orbital rings, 3,000-particle nebula.",
    190,
    "🛸",
    "Flagship",
    buildLanding,
  ...
  e(
    "atrium",
    "The Atrium",
    "12 doors · PBR marble · 24 columns · shadow-casting sun.",
    195,
    "🏛️",
    "Flagship",
    buildAtrium,
  ...
  e(
    "nebula-cathedral",
    "Nebula Cathedral",
    "6 concentric rings, singularity core, 5,000 particles.",
    280,
    "🌌",
    "Flagship",
    buildNebulaCathedral,
    { hdr: true },
  ),
  e(
    "quantum-ocean",
    "Quantum Ocean",
    "Bioluminescent whale loop, jellyfish, coral reef.",
    180,
    "🐋",
    "Flagship",
    buildQuantumOcean,
    { hdr: true, fog: NIGHT_FOG },
  ),
  ...
  e(
    "black-hole",
    "Singularity",
    "Accretion disk warping light around an event horizon.",
    265,
    "🕳️",
    "Cosmos",
    buildBlackHole,
  ...
  e(
    "planets",
    "Planetarium",
    "A system of PBR planets with atmospheres and rings.",
    210,
    "🪐",
    "Cosmos",
    buildPlanets,
  ...
  e(
    "space-elevator",
    "Space Elevator",
    "Climb a tether from surface to orbital station.",
    200,
    "🛗",
    "Cosmos",
    buildSpaceElevator,
  ...
  e(
    "micro",
    "Microscopic",
    "Shrink to a cell — floating organelles and molecular motes.",
    150,
    "🔬",
    "Nature",
    buildMicro,
  ...
  e(
    "ecosystem",
    "Living Ecosystem",
    "Forest, water, weather and drifting life.",
    140,
    "🌳",
    "Nature",
    buildEcosystem,
  ...
  e(
    "disasters",
    "Force of Nature",
    "Storms, volcanoes, and shifting tectonics.",
    15,
    "🌋",
    "Nature",
    buildDisasters,
  ...
  e(
    "voxel-awakening",
    "Voxel Awakening",
    "A 31-dimension block world, reborn.",
    90,
    "🧱",
    "Worlds",
    buildVoxelAwakening,
  ...
  e(
    "time-travel",
    "Time Stream",
    "Epochs ripple outward through a chrono vortex.",
    50,
    "⏳",
    "Mind",
    buildTimeTravel,
  ...
  e(
    "memory-palace",
    "Memory Palace",
    "Rooms of light holding shimmering memories.",
    300,
    "🧠",
    "Mind",
    buildMemoryPalace,
  ...
  e(
    "council",
    "The Council",
    "Twelve glowing seats around a judgement dais.",
    220,
    "⚖️",
    "Mind",
    buildCouncil,
  ...
  e("dna", "Helix", "A spiraling double helix of living code.", 320, "🧬", "Mind", buildDNA, {
    hdr: true,
  }),
  e(
    "dream",
    "Dreamscape",
    "Surreal floating islands under a morphing sky.",
    270,
    "💭",
    "Mind",
    buildDream,
  ...
  e(
    "life-sim",
    "Life Sim",
    "A miniature city breathing with tiny lives.",
    200,
    "🏙️",
    "Concept",
    buildLifeSim,
  ...
  e("vr", "VR Chamber", "A neon grid room — you are now in VR.", 320, "🥽", "Concept", buildVR, {
    hdr: true,
  }),
  e(
    "collab",
    "Collab Space",
    "Shared cursors orbiting a living canvas.",
    190,
    "🤝",
    "Concept",
    buildCollab,
  ...
  e(
    "studio",
    "Studio",
    "A turntable sculpting a glowing form.",
    280,
    "🎨",
    "Concept",
    buildStudio,
  ...
  e(
    "avatar",
    "Avatar Chamber",
    "Customise your operator on a lit dais.",
    195,
    "🧍",
    "Concept",
    buildAvatar,
  ...
  e(
    "physics",
    "Physics Lab",
    "Havok gravity — a rain of bouncing crates & spheres.",
    100,
    "🧲",
    "Concept",
    buildPhysics,
